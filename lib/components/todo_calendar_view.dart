  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // [수정] 이모지 텍스트를 Row(이미지+텍스트)로 변경
          Row(
            children: [
              Image.asset(
                'assets/icon/checklist.png', // 준비한 아이콘 파일명
                width: 24,
                height: 24,
                fit: BoxFit.contain,
              ),
          ...
          if (realPriorityTodo != null)
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: const Color.fromARGB(255, 164, 81, 241),
                ),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
